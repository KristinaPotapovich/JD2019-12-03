...
public class Test_jd02_04 {
    ...
    public void TestA() throws Exception {
        ...
        Scalar scalar = (Scalar) parser.calc(expression);
        double actual = Double.parseDouble(scalar.toString());
        assertEquals("Error " + expression, expected, actual, 1e-5);
    ...
    public void TestB() throws Exception {
        ...
        strAct = var.toString();
        assertArrayEquals("Error " + expression, strExp.toCharArray(), strAct.toCharArray());
    ...
    public void TestC() throws Exception {
        ...
        assertEquals("Error: ", "{{3.0, 3.0}, {4.0, 4.0}}", parser.calc("{{1,1},{2,2}}+2").toString());
        assertEquals("Error: ", "{{-1.0, -1.0}, {0.0, 0.0}}", parser.calc("{{1,1},{2,2}}-2").toString());
        assertEquals("Error: ", "{{2.0, 2.0}, {4.0, 4.0}}", parser.calc("{{1,1},{2,2}}*2").toString());
        assertEquals("Error: ", "{{2.0, 2.0}, {4.0, 4.0}}", parser.calc("{{1,1},{2,2}}+{{1,1},{2,2}}").toString());
        assertEquals("Error: ", "{4.0, 8.0}", parser.calc("{{1,1},{2,2}}*{2,2}").toString());
