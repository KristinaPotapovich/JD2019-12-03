...
public abstract class Var implements Operation {
    ...
    public Var add(Var other) throws CalcException {
        throw new CalcException(lang.get(ErrorMessages.ADDITION));
    }

    @Override
    public Var sub(Var other) throws CalcException {
        throw new CalcException(lang.get(ErrorMessages.SUBTRACTION));
    }

    @Override
    public Var mul(Var other) throws CalcException {
        throw new CalcException(lang.get(ErrorMessages.MULTIPLICATION));
    }

    @Override
    public Var div(Var other) throws CalcException {
        throw new CalcException(lang.get(ErrorMessages.DIVISION));
    }
     ...
     static Var createVar(String strVar) throws CalcException {
        ...
        else
        {
            ...
            if (var != null) {
                ...
                throw new CalcException(lang.get(ErrorMessages.INIT)+" "+strVar);
            }
        }
    }
